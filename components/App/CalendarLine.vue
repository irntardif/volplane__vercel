...
<template>
  <li class="flex flex-wrap border-b border-white py-2.5 lg:py-5 last:border-none">
    ...
    <span class="w-1/3 lg:w-[15%] lg:w-[15%] my-auto text-right lg:text-left"><span v-if="date.hour">> {{ date.hour }}</span></span>
    <span class="text-l xl:text-2xl font-bold uppercase w-full lg:w-[25%] my-auto"><NuxtLink
    ...
    <span class="lg:w-[20%] my-auto"><span v-if="date.category" class="capitalize">{{ date.category }}</span></span> 
